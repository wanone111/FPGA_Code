...
if {[file isfile key_led_top.autotvin.dat]} {
	file delete -force key_led_top.autotvin.dat
}

if {[file isfile key_led_top.autotvout.dat]} {
	file delete -force key_led_top.autotvout.dat
}
