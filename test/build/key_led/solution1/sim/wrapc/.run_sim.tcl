...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "key_led_top.autotvin.dat"
	set constFileTvOut       "key_led_top.autotvout.dat"
	set constFileHdlTvIn     "key_led_top.autohdltvin.dat"
	set constFileHdlTvOut    "key_led_top.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
