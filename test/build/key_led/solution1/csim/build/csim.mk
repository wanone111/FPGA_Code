...
HLS_SOURCES = ../../../../../src/test.cpp ../../../../../src/key_led.cpp
...
$(ObjDir)/test.o: ../../../../../src/test.cpp $(ObjDir)/.dir csim.mk
...
$(ObjDir)/key_led.o: ../../../../../src/key_led.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../src/key_led.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/key_led.d
