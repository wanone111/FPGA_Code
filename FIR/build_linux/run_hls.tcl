...
# ============ OpenCV环境配置阶段 ============
puts "== 配置OpenCV环境 =="
set opencv_path "/home/aa/miniconda3/envs/opencv_env"
...
add_files ../src/fir.h
puts "== 添加测试文件 =="
add_files -tb ../src/fir_tb.cpp -cflags "-I$opencv_include -std=c++14" -csimflags "-L$opencv_lib -Wl,-rpath,$opencv_lib -lopencv_core -lopencv_imgproc -lopencv_imgcodecs"
puts "== 打开/重置解决方案 =="
...
# ============ IP核导出阶段 ============
puts "== 开始导出IP核 =="
export_design -format ip_catalog -rtl verilog -ipname fir_top
