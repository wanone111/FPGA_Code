...
entity fir_top_control_s_axi is
generic (
...
end entity fir_top_control_s_axi;
...
architecture behave of fir_top_control_s_axi is
    ...
    constant ADDR_COEF_DATA_0 : INTEGER := 16#28#;
    constant ADDR_COEF_DATA_1 : INTEGER := 16#2c#;
    constant ADDR_COEF_CTRL   : INTEGER := 16#30#;
    constant ADDR_LEN_DATA_0  : INTEGER := 16#34#;
    constant ADDR_LEN_CTRL    : INTEGER := 16#38#;
