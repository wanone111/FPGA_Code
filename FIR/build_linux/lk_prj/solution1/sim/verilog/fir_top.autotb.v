...
`define AUTOTB_DUT      fir_top
`define AUTOTB_DUT_INST AESL_inst_fir_top
`define AUTOTB_TOP      apatb_fir_top_top
`define AUTOTB_LAT_RESULT_FILE "fir_top.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "fir_top.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_fir_top_top
...
`define AUTOTB_TVIN_gmem  "../tv/cdatafile/c.fir_top.autotvin_gmem.dat"
`define AUTOTB_TVIN_y  "../tv/cdatafile/c.fir_top.autotvin_y.dat"
`define AUTOTB_TVIN_x  "../tv/cdatafile/c.fir_top.autotvin_x.dat"
`define AUTOTB_TVIN_coef  "../tv/cdatafile/c.fir_top.autotvin_coef.dat"
`define AUTOTB_TVIN_len  "../tv/cdatafile/c.fir_top.autotvin_len.dat"
`define AUTOTB_TVIN_gmem_out_wrapc  "../tv/rtldatafile/rtl.fir_top.autotvin_gmem.dat"
`define AUTOTB_TVIN_y_out_wrapc  "../tv/rtldatafile/rtl.fir_top.autotvin_y.dat"
`define AUTOTB_TVIN_x_out_wrapc  "../tv/rtldatafile/rtl.fir_top.autotvin_x.dat"
`define AUTOTB_TVIN_coef_out_wrapc  "../tv/rtldatafile/rtl.fir_top.autotvin_coef.dat"
`define AUTOTB_TVIN_len_out_wrapc  "../tv/rtldatafile/rtl.fir_top.autotvin_len.dat"
`define AUTOTB_TVOUT_gmem  "../tv/cdatafile/c.fir_top.autotvout_gmem.dat"
`define AUTOTB_TVOUT_gmem_out_wrapc  "../tv/rtldatafile/rtl.fir_top.autotvout_gmem.dat"
module `AUTOTB_TOP;
