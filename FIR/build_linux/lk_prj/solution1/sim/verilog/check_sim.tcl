...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.fir_top.autotvin_gmem.dat"
         "c.fir_top.autotvin_y.dat"
         "c.fir_top.autotvin_x.dat"
         "c.fir_top.autotvin_coef.dat"
         "c.fir_top.autotvin_len.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.fir_top.autotvout_gmem.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
