...
//------------------------Parameter----------------------
`define TV_IN_gmem "../tv/cdatafile/c.fir_top.autotvin_gmem.dat"
`define TV_OUT_gmem "../tv/rtldatafile/rtl.fir_top.autotvout_gmem.dat"
    ...
    while (1) begin
        if (FIFO_AW_req_empty === 1 || BRESP_counter == 32) begin
            ...
            if (FIFO_AW_req_ADDR_tmp/data_byte_size > gmem_mem_depth) begin
                $display ("/home/aa/FPGA_space/FIR/build_linux/lk_prj/solution1/sim/verilog/AESL_axi_master_gmem.v: Write request address %d exceed AXI master gmem array depth: %d",FIFO_AW_req_ADDR_tmp/data_byte_size, gmem_mem_depth); 
                $finish;
            end
    ...
    while (1) begin
        ...
        if (FIFO_AR_req_empty) begin
            ...
            if (FIFO_AR_req_ADDR_tmp/data_byte_size > gmem_mem_depth) begin
                $display ("/home/aa/FPGA_space/FIR/build_linux/lk_prj/solution1/sim/verilog/AESL_axi_master_gmem.v: Read request address %d exceed AXI master gmem array depth: %d",FIFO_AR_req_ADDR_tmp/data_byte_size, gmem_mem_depth); 
                $finish;
            end
...
initial begin : runtime_depth_init_process
    gmem_port0_fresh_depth[0] = 99;
    gmem_port0_blank_depth[0] = 0;
    gmem_port1_fresh_depth[0] = 100;
    gmem_port1_blank_depth[0] = 0;
    gmem_port2_fresh_depth[0] = 100;
