...
extern "C"
#endif
void apatb_fir_top_ir(int *, int *, int *, int);
#ifdef __cplusplus
extern "C"
#endif
void fir_top_hw_stub(int *y, int *x, int *coef, int len){
fir_top(y, x, coef, len);
return ;
}
#ifdef __cplusplus
extern "C"
...
extern "C"
#endif
void apatb_fir_top_sw(int *y, int *x, int *coef, int len){
refine_signal_handler();
apatb_fir_top_ir(y, x, coef, len);
return ;
}
#endif
# 54 "/home/aa/FPGA_space/FIR/src/fir.cpp"
