...
$(ObjDir)/fir_tb.cpp_pre.cpp.tb.o : fir_tb.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	...
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN} -std=gnu++14 -fno-builtin-isinf -fno-builtin-isnan -c -std=c++14 -L/home/aa/miniconda3/envs/opencv_env/lib -Wl,-rpath,/home/aa/miniconda3/envs/opencv_env/lib -Wno-unknown-pragmas -Wno-unknown-pragmas $(IFLAG) $(DFLAG) $< -o $@; \
