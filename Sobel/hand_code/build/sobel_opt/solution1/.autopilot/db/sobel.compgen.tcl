...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler sobel_sparsemux_5_2_2_1_1 BINDTYPE {op} TYPE {sparsemux} IMPL {onehotencoding_realdef}
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler sobel_LineBuffer_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
