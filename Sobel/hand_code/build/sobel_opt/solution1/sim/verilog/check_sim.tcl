...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.sobel.autotvin_src_V_data_V.dat"
         "c.sobel.autotvin_src_V_keep_V.dat"
         "c.sobel.autotvin_src_V_strb_V.dat"
         "c.sobel.autotvin_src_V_last_V.dat"
         "c.sobel.autotvin_rows.dat"
         "c.sobel.autotvin_cols.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.sobel.autotvout_dst_V_data_V.dat"
         "rtl.sobel.autotvout_dst_V_keep_V.dat"
         "rtl.sobel.autotvout_dst_V_strb_V.dat"
         "rtl.sobel.autotvout_dst_V_last_V.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
